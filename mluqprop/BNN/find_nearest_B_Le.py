...
for i in range(10):
    ...
    par.printRoot(f"\tB_LE FW4 min {min_ble_4:.2f} max {max_ble_4:.2f}")
    par.printRoot(f"\tB_LE FW16 min {min_ble_16:.2f} max {max_ble_16:.2f}")
...
par.printRoot(f"\tB_LE UNSCALED FW4 min {min_ble_4:.2f} max {max_ble_4:.2f}")
par.printRoot(f"\tB_LE UNSCALED FW16 min {min_ble_16:.2f} max {max_ble_16:.2f}")
...
if par.irank == par.iroot:
    np.save("distToDS_B_Le_FW4.npy", distToDS_fw4)
...
if par.irank == par.iroot:
    np.save("distToDS_B_Le_FW16.npy", distToDS_fw16)
